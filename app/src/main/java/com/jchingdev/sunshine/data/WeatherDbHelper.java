...
/**
 * Created by Joshua on 2016-03-12.
 */
public class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + WeatherContract.WeatherEntry.TABLE_NAME + " (" +
                ...
                " FOREIGN KEY (" + WeatherContract.WeatherEntry.COLUMN_LOCATION_KEY + ") REFERENCES " + WeatherContract.LocationEntry.TABLE_NAME + " (" + WeatherContract.LocationEntry._ID + "), " +
                " UNIQUE (" + WeatherContract.WeatherEntry.COLUMN_DATE + ", " + WeatherContract.WeatherEntry.COLUMN_LOCATION_KEY + ") ON CONFLICT REPLACE);";
